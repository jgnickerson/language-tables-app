...
echo -e "\nEnter course:"
read var7
#var7="CHNS 0301" # uncomment if you are doing many students in a row with same course
...
echo -e "\nNow, enter the number of times this entry should be duplicated."
echo -e "\nEnter seat count:"
read var9
...
function ask_double_check {
  ...
  if [ "$answer" = "Y" ] || [ "$answer" = "y" ]; then
    ...
    string="var start='$var1'; var end='$var2'; var id='$var3'; var firstName='$var4'; var lastName='$var5'; var email='$var6'; var course='$var7'; var day='$var8'; var seatCount='$var9';"
    mongo localhost:3001/lt --eval "$string" populateAnonymous.js
